...
include $(CLEAR_VARS)
LOCAL_MODULE    := gstreamer_udpsink
LOCAL_SRC_FILES := gstreamer_udpsink.c
LOCAL_SHARED_LIBRARIES := android_camera gstreamer_android
LOCAL_LDLIBS := -llog
include $(BUILD_SHARED_LIBRARY)
...
GSTREAMER_PLUGINS         := $(GSTREAMER_PLUGINS_CORE) $(GSTREAMER_PLUGINS_ENCODING) opensles $(GSTREAMER_PLUGINS_CODECS) $(GSTREAMER_PLUGINS_NET)
